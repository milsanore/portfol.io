...
- for additional performance improvement on the python side, a JIT compiler like PyPy could work, but it was a diminishing return for the repo above because it's IO-heavy, so the bulk of the improvement was in the event loop / async work
